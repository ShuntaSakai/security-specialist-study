...
採点は意味内容で行う。同義表現を認め、問題が求めていない専門語の欠如だけで減点しない。重大な因果逆転、攻撃者と被害者の混同、安全でない対策の推奨は大きく減点する。回答が空なら採点せず、セッションを未採点のままにする。一方、理解・応用問題を含む全モードで、`わかりません` など明示的に解答不能を表す記入は回答済みとして `0 / 100` を付け、模範的な説明と次回確認する観点を記録する。
